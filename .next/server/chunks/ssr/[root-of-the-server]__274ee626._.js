...
"[project]/src/components/floating-whatsapp.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function FloatingWhatsApp({ phoneNumber = "6281234567890", message = "Hello! I'm interested in your services." }) {
...
"[project]/src/components/error-boundary.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Component"] {
    ...
    isBrowserExtensionError(error) {
        ...
        return extensionErrorPatterns.some((pattern)=>error.message.includes(pattern) || error.stack?.includes(pattern));
    }
    handleRetry = ()=>{
        this.setState({
            hasError: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__274ee626._.js.map