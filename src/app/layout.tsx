...
export const metadata: Metadata = {
  ...
  keywords: ['web development', 'web design', 'digital agency', 'website creation', 'LivingTech Creative', 'custom websites', 'SEO optimization'],
  ...
  return (
    <html lang="en" className={`${inter.variable} ${interDisplay.variable} font-sans`} style={{ fontFamily: 'Trap, sans-serif' }}>
      <head>
        ...
        {/* Favicon - Lengkap dengan asset baru */}
        ...
        <link rel="preconnect" href="https://dashboard.livingtechcreative.com" />
        <link rel="dns-prefetch" href="https://dashboard.livingtechcreative.com" />
      </head>
